...
public class Util {
    ...
    public static final String API = "http://notification.intexvas.in/";//"http://notification.intexvas.in/";
    public static final String API_URL_ANALYTICS = "http://notification.intexvas.in/analytics";//"http://notification.intexvas.in/analytics";
