    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals(Util.UPDATE_ACTION)) {
            ...
            if(Util.isNetworkAvailable(mContext)){
               ...
               // new SendAnalyticsData(mContext, Util.EVENT_LABEL).execute(Util.EVENT_REFRESH_BUTTON_CLICKED);
            ...
            if(Util.isNetworkAvailable(mContext)){
              ...
              //  new SendAnalyticsData(mContext, Util.CLICKED_APP +"deal_").execute(extraObtained);
                Util.createAndSendAnalyticsData(Util.CLICKED_APP, Util.CATEGORY_BANNER, Util.APP_PACKAGE_NAME, extraObtained, mContext);
                try {
...
//        }
        ...
        case 1:
            return R.drawable.widget_text_bg;// orange
        case 2:
            return R.drawable.widget_text_bg;// green
        case 3:
            return R.drawable.widget_text_bg;// purple
        case 4:
            return R.drawable.widget_text_bg;// blue
        default:
            return R.drawable.widget_text_bg;// red
    }
    }
