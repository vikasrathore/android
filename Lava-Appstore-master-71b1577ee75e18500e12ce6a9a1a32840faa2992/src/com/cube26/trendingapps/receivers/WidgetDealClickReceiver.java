        ...
        if (Util.isAppAlreadyInstalled(pckgName, context)) {
            ...
            try {
               ...
               // new SendAnalyticsData(context, Util.DEAL_APP_OPENED).execute(pckgName);
                Util.createAndSendAnalyticsData(Util.DEAL_APP_OPENED, Util.CATEGORY_MANUAL, Util.APP_PACKAGE_NAME, pckgName, context);
            } catch (Exception e) {
        ...
        if(Util.isNetworkAvailable(context)){
            ...
            try {
              ...
              //  new SendAnalyticsData(context, Util.DEAL_BROWSER_OPENED).execute(pckgName);
                Util.createAndSendAnalyticsData(Util.DEAL_BROWSER_OPENED, Util.CATEGORY_MANUAL, Util.APP_PACKAGE_NAME, pckgName, context);
            } catch (Exception e) {
