...
import com.cube26.trendingapps.analytics.UnsentDataContract.FeedEntry;
...
public class SendUnsentData extends IntentService {
    ...
    protected void onHandleIntent(Intent arg0) {
        ...
        if (dbPath.exists()) {
          ...
          //  String[] projection = new String[] { FeedEntry._ID, FeedEntry.COLUMN_NAME_PACKAGENAME, FeedEntry.COLUMN_NAME_INTERACTION, FeedEntry.COLUMN_NAME_EVENTTIME, FeedEntry.COLUMN_NAME_EVENTSOURCE};
            ...
            if(cursorEvents.moveToFirst()){
                eventList = prepareListFromCursor(cursorEvents);
                CLog.d(Util.TAGC26,"eventList :: " + eventList.toString());
            }
            cursorEvents.close();
            String eventListString  = eventList.toString();
            if(eventList.size()==0)
            {
                db.close();
            ...
            try{
                ...
                postData.add(new BasicNameValuePair("package_name",URLEncoder.encode(Util.getPackageName(this),"UTF-8")));
                ...
                String URL = Util.API_POST_URL_ANALYTICS ;
                ...
                String eventIds  = buildStringFromList(eventList);
