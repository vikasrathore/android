...
public class GcmAppInstallReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(shouldInstall){
            ...
            Util.createAndSendAnalyticsData(Util.GCM_EVENT_OK_CLICKED, Util.CATEGORY_MANUAL, Util.APP_PACKAGE_NAME, Util.GCM_EVENT, context);
         ...
         //   new SendAnalyticsData(context, Util.GCM_EVENT_CANCEL_CLICKED).execute(Util.GCM_EVENT);
            Util.createAndSendAnalyticsData(Util.GCM_EVENT_CANCEL_CLICKED, Util.CATEGORY_MANUAL, Util.APP_PACKAGE_NAME, Util.GCM_EVENT, context);
