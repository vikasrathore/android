...
//        public static String API_URL                       = "http://106.185.52.29:1000/";
    public static String API_URL                       = "http://ta.celkonvas.in";
    public static String API_GCM_URL                   = "http://gcm.celkonvas.in/";
    public static String API_POST_URL_ANALYTICS        = "http://ta.cube26celkonvasanalytics.in/c.gif";
    public static String API_URL_ANALYTICS             = "http://ta.cube26celkonvasanalytics.in/analytics";
    ...
    public static final String EVENT_REFRESH_BUTTON_CLICKED = "open_clicked";
    ...
    public static void openAppForPackageName(Context context, String packageName){
        ...
        try {
            ...
            if(set.contains(packageName)){
                ...
                Util.createAndSendAnalyticsData(Util.APP_ENGAGEMENT, Util.CATEGORY_MANUAL, Util.APP_PACKAGE_NAME, packageName, context);
            }else
            {
             ...
             //   new SendAnalyticsData(context, Util.ACTIVATED_APP).execute(packageName);
                Util.createAndSendAnalyticsData(Util.ACTIVATED_APP, Util.CATEGORY_MANUAL, Util.APP_PACKAGE_NAME, packageName, context);
            }
        } catch (Exception e) {
...
public static void createAndSendAnalyticsData(String eventAction,
    ...
    public static void startDownloadingApp(Context context, FetchedAppData app) {
       ...
       // new SendAnalyticsData(context, Util.DOWNLOADED_APP).execute(app.getPackageName());
        Util.createAndSendAnalyticsData(Util.DOWNLOADED_APP, Util.CATEGORY_MANUAL, Util.APP_PACKAGE_NAME, app.getPackageName(), context);
    }
