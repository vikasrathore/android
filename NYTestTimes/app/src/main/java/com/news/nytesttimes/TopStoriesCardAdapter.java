 ...
 */
public class TopStoriesCardAdapter extends RecyclerView
        .Adapter<TopStoriesCardAdapter
        .DataObjectHolder> {

    ArrayList<News> news;
    Bitmap defaultIcon;
    TopStoriesFragment.OnFragmentInteractionListener listener;
    public TopStoriesCardAdapter(ArrayList<News> news, Bitmap bitmap,TopStoriesFragment.OnFragmentInteractionListener listener) {
        this.news = news;
        defaultIcon = bitmap;
    ...
    @Override
    public TopStoriesCardAdapter.DataObjectHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                listener.onTopStoriesItemClicked(mSelectedPosition, news.get(mSelectedPosition).getNewsWebURL());
    ...
    @Override
    public void onBindViewHolder(TopStoriesCardAdapter.DataObjectHolder holder, int position) {
